...
namespace HETS1Design
{
    ...
    public static class MainScreenLogic
    {
        ...
        //function that is called when ZIP is selected in dialog
        ...
        public static void OnShowResults(DataGridView dataGridResults, Button btnDetailedResults)//TextBox textBoxTEMPORARY)
        {
            ...
            {
                if (MainScreen.main1.cbComment.Checked)
                    dataGridResults.Columns[5].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;

                dataGridResults.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            }
            else if(MainScreen.main1.cbComment.Checked)
            {
